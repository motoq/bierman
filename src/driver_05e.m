...
% This bias is held constant for each trajectory.  Two methods for
% computing the covariance are compared.
%
% Kurt Motekew  2018/12/14
%
...
for ii = 2:nfilt
  ...
  S = -Rxinv*Rxy;
  Pn = Rninv*Rninv';
  Px = Pn(1:6,1:6);                              % Bierman equivalent
  Py = Pn(7:9,7:9);
  P_hat = Px + S*Py*S';
...
fprintf('\n SRIF Time:\t%1.4f seconds', srif2_time);
fprintf('\n');
